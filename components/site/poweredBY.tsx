import { PackageCheck, Triangle } from "lucide-react";
  ...
  return (
    <div className="w-full">
      <div className="wu-max flex-center flex-col gap-10">
        <h1 className="text-5xl">Powered by</h1>
        <div className="w-80 h-1 rounded-full bg-primary" />
        <Marquee className="py-7">
          <Link
            className="flex items-center gap-3 text-2xl hover:scale-150 transition-all mx-16"
          ...
          {/* <Link className='flex items-center gap-3 text-2xl hover:scale-150 transition-all mx-16' href={'https://t.me/developer_23_05'}>
                    <Image src={'https://www.djangoproject.com/m/img/logos/django-logo-negative.svg'} width={105} height={40} alt='django' /></Link> */}
          <Link
            className="flex items-center gap-3 text-2xl hover:scale-150 transition-all mx-16"
