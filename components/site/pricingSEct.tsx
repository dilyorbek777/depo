...
const Pricing = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-background pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 dark:border-0 border-stroke dark:bg-accent px-8 py-10 shadow-pricing dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
